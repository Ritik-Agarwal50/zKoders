...
const topArticles: Article[] = [
  {
    title:
      "Learn to use Supabase with Next JS - A Beginner Friendly Application",
    content:
  ...
  },
  {
    ...
    bloglink:
      "https://aahiknsv.hashnode.dev/building-a-todo-application-in-solidity",
  },
  {
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-6 mt-12 mb-32 mx-10 xl:mx-32">
        {topArticles.map((article, index) => (
          ...
          >
            ...
            <p className="tracking-wider mt-4 text-black text-md">
              {article.content}
            </p>
